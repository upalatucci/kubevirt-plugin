...
import type {
  AccessReviewResourceAttributes as OriginalAccessReviewResourceAttributes,
  K8sResourceCommon as OriginalK8sResourceCommon,
...
declare global {
  ...
  type AccessReviewResourceAttributes = OriginalAccessReviewResourceAttributes & {
    cluster?: string;
  };
