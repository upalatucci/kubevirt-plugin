...
import useNamespacedResources from '@kubevirt-utils/hooks/useNamespacesResources';
...
import { getErrorDataSourceName } from '../../../utils/selectors';
...
const DiskSourceDataSourceSelectName: FC = () => {
  ...
  const error = getErrorDataSourceName(errors);
